...
class ThreatAnalyzer:
    def __init__(self):
        ...
        # --- Tracker: DeepOCSort (frames pre-resized at WS level) ---
    ...
    def analyze(self, annotated_frame, detections):
        try:
            # Frames are pre-resized to 1280x720 at WebSocket level
            ...
            try:
                ...
                print(f"ERROR in ThreatAnalyzer tracker.update: {e}")
                import traceback
                traceback.print_exc()
                return frame, {}
            ...
            print(f"CRITICAL ERROR in ThreatAnalyzer.analyze: {e}")
            import traceback
            traceback.print_exc()
            # Return original frame without threat analysis
